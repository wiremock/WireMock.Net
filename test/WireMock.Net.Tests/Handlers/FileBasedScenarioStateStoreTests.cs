...
public class FileBasedScenarioStateStoreTests : IDisposable
{
    ...
    public void Get_ShouldBeCaseInsensitive()
    {
        ...
        sut.Get("scenario1")!.NextState.Should().Be("state2");
        sut.Get("SCENARIO1")!.NextState.Should().Be("state2");
    }
    ...
    public void Constructor_ShouldLoadExistingScenariosFromDisk()
    {
        ...
        sut.Get("scenario1")!.NextState.Should().Be("loaded1");
        sut.Get("scenario2")!.Counter.Should().Be(3);
    }
